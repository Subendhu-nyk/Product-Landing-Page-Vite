  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
        <p className='text-xl font-montserrat text-coral-red pt-16'>
          Our New Collections
        </p>

        <h1 className='mt-2 font-palanquin text-[75px] max-sm:text-[55px] max-sm:leading-[82px] font-bold'>
          <span className='xl:bg-white xl:whitespace-nowrap relative z-10 pr-10'>
          Trust Us, Heal Better
          </span>
          <br />
          <span className='text-coral-red inline-block mt-3'>Urmila</span> Pharmacy
        </h1>
